...
$searchFilters = array(
	...
	'@chunkybot',		//don't retweet mentions
);
$userFilters = array();
...
//////////////////////////////////////////////////////////////////////////
$lastSearch = @json_decode(file_get_contents(MYPATH . '/lastsearch3.json'));
...
file_put_contents(MYPATH . '/lastsearch3.json', json_encode($data));
